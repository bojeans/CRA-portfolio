...
const SkillsCard = ({ icon, experience, description }) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg m-4 sm:w-1/2 lg:w-1/3 skills-page">
      <div className="px-6 py-4">
        <ul className="flex font-bold text-gray-400 text-3xl mt-2 mb-5 skills-icons">
          {icon}
        </ul>
