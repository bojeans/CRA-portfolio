...
//           <li className="mb-4">
//             <strong className="sub-title">Agile DevOps</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">CSS3</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Databases</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Docker</strong>
//             <CollapsibleText
//               text="I have used
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Git, Github & VScode</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">HTML5</strong>
//             <CollapsibleText
//               text="including
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Javascript</strong>
//             <CollapsibleText
//               text="Basic
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Node.js</strong>
//             <CollapsibleText
//               text="for my
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">OpenAPI/Swagger</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Python</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">React.js</strong>
//             <CollapsibleText
...
//           </li>
//           <li className="mb-4">
//             <strong className="sub-title">Testing/TDD</strong>
//             <CollapsibleText
